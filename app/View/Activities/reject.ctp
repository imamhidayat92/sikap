<div class="row">
    <div class="six columns offset-by-three">
        <h1 class="opensans bg-red" style="color: white;">Tolak</h1>
        <h2 class="opensans">Anda akan melakukan persetujuan pada aktifitas berikut untuk ditolak.</h2>
        ...
        <div style="text-align: right;">
            <form method="POST" action="<?php echo Router::url(array('controller' => 'activities', 'action' => 'reject', $activity['Activity']['id'])) ?>">
