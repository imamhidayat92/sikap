<div class="row">
    <div class="six columns offset-by-three">
        <h1 class="opensans bg-green" style="color: white;">Verifikasi</h1>
        <h2 class="opensans">Anda akan melakukan persetujuan pada aktifitas berikut untuk di verifikasi.</h2>
        ...
        <div style="text-align: right;">
            <form method="POST" action="<?php echo Router::url(array('controller' => 'activities', 'action' => 'verify', $activity['Activity']['id'])) ?>">
